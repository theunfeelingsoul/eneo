			...
			<div class="sidebar col-md-2">
				<div class="row">
					<ul class="nav-sidebar">
						...
						<?= 
							Yii::$app->controller->id == 'adimg' ? 
							'<li class="nav-sidebar-active">':
							'<li class="">';
						 ?>
							<span class="glyphicon glyphicon glyphicon-picture"></span>&nbsp;&nbsp;&nbsp;
							<?= Html::a('Albums', ['adimg/index'], ['class' => '']) ?>
						</li>
						<?= 
							Yii::$app->controller->id == 'leads' ? 
							'<li class="nav-sidebar-active">':
							'<li class="">';
						 ?>
							<span class="glyphicon glyphicon glyphicon-picture"></span>&nbsp;&nbsp;&nbsp;
							<?= Html::a('Leads', ['leads/index'], ['class' => '']) ?>
						</li>

						<?= 
							Yii::$app->controller->id == 'trackleads' ? 
							'<li class="nav-sidebar-active">':
							'<li class="">';
						 ?>
							<span class="glyphicon glyphicon glyphicon-picture"></span>&nbsp;&nbsp;&nbsp;
							<?= Html::a('Track leads', ['leads/trackleads'], ['class' => '']) ?>
						</li>
						<?= 
							Yii::$app->controller->id == 'sortableleads' ? 
							'<li class="nav-sidebar-active">':
							'<li class="">';
						 ?>
							<span class="glyphicon glyphicon glyphicon-picture"></span>&nbsp;&nbsp;&nbsp;
							<?= Html::a('Sortable', ['sortableleads/index'], ['class' => '']) ?>
						</li>
					</ul>
				</div>
			</div>
